...
window.Modernizr = (function( window, document, undefined ) {
     ...
     *    device, as evidenced by tabvars running Windows 7 or, alas,
    ...
    // Just FWIW: IE8 Compat mode supports these features compvarely:
    ...
    function webforms() {
        ...
        Modernizr['input'] = (function( props ) {
            ...
            return attrs;
        })('autocompvare autofocus list placeholder max min multiple pattern required step'.split(' '));
        /*>>input*/
