...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var Util = (function () {
            ...
            Util.devareCookie = function (name) {
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var AjaxMonitor = (function () {
                ...
                xhr.ajaxData.xhrMonitoringState.onreadystatechangeCallbackAttached = ApplicationInsights.EventHelper.AttachEvent(xhr, "readystatechange", function () {
                    try {
                        if (ajaxMonitorInstance.isMonitoredInstance(xhr)) {
                            if (xhr.readyState === 4) {
                                ajaxMonitorInstance.onAjaxCompvare(xhr);
                            }
                        }
                    }
                    catch (e) {
            ...
            AjaxMonitor.prototype.onAjaxCompvare = function (xhr) {
    ...
    (function (ApplicationInsights) {
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                devare source[circularReferenceCheck];
                return output;
            };
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.clearAuthenticatedUserContext = function () {
                    ...
                    this.accountId = null;
                    ApplicationInsights.Util.devareCookie(User.authUserCookieName);
                };
    ...
    (function (ApplicationInsights) {
        ...
        var Sender = (function () {
            ...
            Sender.prototype.send = function (envelope) {
                var _this = this;
                try {
                    if (this._config.disabvarelemetry()) {
                        return;
                    }
                    if (!envelope) {
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    disabvarelemetry: function () { return _this.config.disabvarelemetry; },
        ...
        var Initialization = (function () {
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.disableExceptionTracking = (config.disableExceptionTracking !== undefined && config.disableExceptionTracking !== null) ?
                    ...
                    false;
                config.disabvarelemetry = ApplicationInsights.Util.stringToBoolOrDefault(config.disabvarelemetry);
