...
let record_name = document.querySelector('#name');
//let play_audio = document.querySelector('#play');
...
let handlers = {
    ...
    createElements: function (id, _name, src) {
        ...
        let voiceContainer = document.querySelector(".voice");
    ...
    deleteVoice: function (id) {
        voice_record.delete(id);
        voice_record_view.displayRecords();
    },
    playVoice: function (id) {
        let url = voice_record.play(id);
    ...
    setUpEventListeners: function () {
        ...
        voiceContainer.addEventListener('click', function (event) {
            ...
            if (event.target.id == 'play') {
                ...
                document.querySelector('.voice').innerHTML = '';
                handlers.deleteVoice(event.target.value);
...
function upload(file, word, target) {
    ...
    request.addEventListener("progress", function (e) {
        ...
        // console.log(e);
        if (pc == 100) {
            setTimeout(function () { handlers.deleteVoice(target.id); }, 1500);
...
function getName() {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            //response
            console.log(request.response);
            //let play = document.querySelector("#retrieve");
            //let audio = document.querySelector(".re");
